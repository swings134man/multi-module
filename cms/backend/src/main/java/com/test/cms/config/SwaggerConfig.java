...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private static final String SERVICE_NAME = "multi-module Project";
    private static final String API_VERSION = "V1";
    private static final String API_DESCRIPTION = "multi-module CMS API TEST";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title(SERVICE_NAME) // 서비스명
                ...
                .licenseUrl("https://github.com/swings134man/multi-module")
                .build();
    }// API INFO
